...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Sidebar */}
      <aside className={`bg-violet-700 text-black w-64 p-4 space-y-4 md:block ${isOpen ? 'block' : 'hidden'} fixed md:relative z-20`}>
        <h2 className="text-2xl font-bold mb-6">Dashboard</h2>
        <NavLink to="/dashboard" className="block py-2 px-4 rounded hover:bg-violet-600">Home</NavLink>
